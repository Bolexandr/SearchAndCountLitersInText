...
})({"jQkTS":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d6c79c5da83036ce";
"use strict";
...
},{}],"hjJdW":[function(require,module,exports) {
...
function getObjLitersNumbers(text) {
    ...
    for (let liter of arrFromText.sort())/// пербираю форОфом відсортований масив
    ...
    for (let i of arrFromText)///перебираю масив всіх літер
    if (i !== " ") ///перевіряю чи літера не пробіл
    ...
    const arrOfArrFilterleters = [
        ...arrOfArr
    ].sort((a, b)=>b[1] - a[1]); ///сортую скопійований масив по кількості збігів на спадання
    const objOfFilterLiters = {};
    for (let i1 of arrOfArrFilterleters){
        const nameOfLitr = i1[0];
        const valueOfLiter = i1[1];
        objOfFilterLiters[nameOfLitr] = valueOfLiter;
    }
    // console.log(objOfFilterLiters);
    // console.table(arrOfArrFilterleters);
    return {
        arrOfArrFilterleters,
        objOfFilterLiters
    };
}
...
function renderToDom(InputText) {
    ...
    const arrString = liters.arrOfArrFilterleters.map((elArr)=>`<tr><td>${elArr[0]}</td><td>${elArr[1]}</td> </tr>`).join("");
...
},{}]},["jQkTS","hjJdW"], "hjJdW", "parcelRequire9d70")

//# sourceMappingURL=index.a83036ce.js.map
